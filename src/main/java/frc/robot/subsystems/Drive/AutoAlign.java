...
public class AutoAlign extends Command {
  ...
  // now always align to front-center of the fiducial
  private Timer dontSeeTagTimer, stopTimer;
  private frc.robot.subsystems.Drive.CommandSwerveDrivetrain drivebase;
  private double tagID = -1;

  public AutoAlign(frc.robot.subsystems.Drive.CommandSwerveDrivetrain drivebase) {
  ...
  // Y setpoint 0 is the center line in target space — front-center alignment
